...
namespace shoponline.Areas.Administrators.Controllers
{
    public class ServicesController : BaseController
    {
        ...
        {
            int pageNum = page ?? 1;
            var entity = Dao.ListAllByTaxonomy("Service");
            var output = new List<ServicesModel>();
            foreach (var item in entity)
            {
                output.Add(new ServicesModel
                {
        ...
        {
            ViewBag.CategoryId = new SelectList(DaoCategories.ListAllByTaxonomy("Service"), "Id", "Title");
            return View();
        }
        ...
        [ValidateInput(false)]
        public ActionResult Add(ServicesModel input)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Edit", "Services", new { Id = Id });
            }
        ...
        public ActionResult Edit(long? Id)
        {
            ...
            ViewBag.CategoryId = new SelectList(DaoCategories.ListAllByTaxonomy("Service"), "Id", "Title", ouput.CategoryId);
            return View(ouput);
        }
